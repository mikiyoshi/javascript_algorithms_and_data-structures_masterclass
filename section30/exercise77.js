...
console.log('2: ', minCoinChangeBF([9, 6, 5, 1], 12)); // 2
console.log('4: ', minCoinChangeBF([10, 25], 85)); // 4
...
console.log('2223: ', minCoinChangeTD([9, 6, 5, 1], 20000)); // 2223
console.log('4: ', minCoinChangeTD([10, 25], 85)); // 4
...
console.log(
  '{ coins: [ 25, 25, 25, 25, 25, 10 ], minNumberOfCoins: 6 }: ',
  minCoinChangeBU([10, 25], 135)
); // { coins: [ 25, 25, 25, 25, 25, 10 ], minNumberOfCoins: 6 }
console.log(
  '{ coins: [ 6, 5 ], minNumberOfCoins: 2 }: ',
  minCoinChangeBU([1, 5, 6, 9], 11)
); // { coins: [ 6, 5 ], minNumberOfCoins: 2 }
...
console.log('[ 25, 25, 25, 10 ]: ', minCoinChangeGA([10, 25], 85)); // [ 25, 25, 25, 10 ]
console.log('[ 50, 20 ]: ', minCoinChangeGA([1, 2, 5, 10, 20, 50, 100], 70)); // [ 50, 20 ]

// greedy algorithm does not always work properly
console.log(
  '[ 9, 1, 1 ] - instead of [6, 5]: ',
  minCoinChangeGA([1, 5, 6, 9], 11)
); // [ 9, 1, 1 ] - instead of [6, 5]
